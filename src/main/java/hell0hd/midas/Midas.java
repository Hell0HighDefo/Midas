package hell0hd.midas;

import eu.midnightdust.lib.config.MidnightConfig;
import hell0hd.midas.registry.item.ModItems;
import hell0hd.midas.registry.loot.ModLootTableModifiers;
...
public class Midas implements ModInitializer {
	...
	public void onInitialize() {
		...
		LOGGER.info("touch me midas_ow2");
		MidnightConfig.init(Midas.MOD_ID, MidasConfig.class);
